...
const projects = [
  {
    ...
    summary: "ArchLink centralise la supervision des arches de lecture DPD afin d’identifier les incidents avant qu’ils n’impactent les opérations.",
    role: "Développée de bout en bout en méthode Agile, du recueil du besoin jusqu'au déploiement. Mon MA comme appui technique, l'équipe SI-INDUS comme utilisateurs finaux, la DSI comme contrainte réglementaire.",
    delivered: [
      ...
      "Architecture parallèle Celery/Redis : 8 agences traitées simultanément en moins de 30 secondes par cycle. Avant optimisation",
      "~33 000 colis supervisés par jour. Détection de panne réseau. Paramètres centralisés et modifiables sans redémarrage.",
      "Gestion RGPD avec la DSI — questionnaire de conformité, audit de sécurité, documentation complète du projet pour les équipes de maintenance.",
    ],
    ...
    tags: ["FastAPI", "React", "PostgreSQL", "Celery", "Redis", "SFTP", "Docker", "RGPD", "Alternance"],
    github: null,
  },
  {
    emoji: "🐝",
...
const otherProjects = [
  ...
  },
  {
    ...
    role: "Câblage, mesures à l'oscilloscope (fréquences de résonance, amortissement, filtres), caractérisation d'un capteur industriel à effet Hall : sensibilité, précision, limites.",
