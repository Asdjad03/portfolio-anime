...
function SocialLinks({ visible }: Props) {
  return (
    <motion.div
      style={{ opacity: visible ? 1 : 0, transition: "opacity 0.8s ease" }}
      className="absolute bottom-10 left-16 z-20 flex flex-col items-center gap-5 xl:left-24"
    >
      <div className="h-12 w-px bg-gradient-to-t from-[#38BDF8] to-transparent" />

      <a
        href="https://github.com/Asdjad03"
        target="_blank"
        rel="noreferrer"
        className="text-[#CBD5E1] transition hover:text-[#38BDF8] hover:scale-110"
      >
      ...
      <a
        href="mailto:asdjad.ab3@gmail.com"
        className="text-[#CBD5E1] transition hover:text-[#38BDF8] hover:scale-110"
      >
      ...
      <div className="h-12 w-px bg-gradient-to-b from-[#38BDF8] to-transparent" />
    </motion.div>
  );
}
